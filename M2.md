...
```bash
curl -s https://raw.githubusercontent.com/mage2click/docker-magento-mutagen/feature/magento-1/lib/setup | bash -s -- -i
```
...
```bash
curl -s https://raw.githubusercontent.com/mage2click/docker-magento-mutagen/feature/magento-1/lib/setup | bash -s -- --domain=magento2.test
```
...
```bash
curl -s https://raw.githubusercontent.com/mage2click/docker-magento-mutagen/feature/magento-1/lib/setup | bash -s -- -h
```
