...
### Admin Panel
The admin panel URL is auto-generated by the setup script. You can find the URL in the output in your terminal. The default username is `john.smith` and the default password is `password123`. You are free to change these default values in the following file:
`compose/magento-2/bin/setup/start`
